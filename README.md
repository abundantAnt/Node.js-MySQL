...
5. Then create a Node application called `bamazon.js`. Running this application will first display all of the items available for sale. Include the ids, names, and prices of products for sale.
